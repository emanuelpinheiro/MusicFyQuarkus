...
insert into usuario (nome, login, senha, cpf, perfil) values ('nome4', 'login4', '+V1RmhsqZa6fRdqCi7bRS9BwnbPdd0SxjI3LvjZKZJhNFygaVC+k4x72yek7FmEU8S0XRqYELH/o4tDMME3wsQ==', '999.999.999-99', 2);
insert into usuario (nome, login, senha, cpf, perfil) values ('nome5', 'login5', '+V1RmhsqZa6fRdqCi7bRS9BwnbPdd0SxjI3LvjZKZJhNFygaVC+k4x72yek7FmEU8S0XRqYELH/o4tDMME3wsQ==', '999.999.999-99', 2);

=======
>>>>>>> ae79a238e1fd15a49ff084b6566d91cabf66e7bc
