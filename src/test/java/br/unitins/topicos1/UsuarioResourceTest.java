...
// public class UsuarioResourceTest {    @Inject
//     UsuarioService usuarioService;    @Test
=======
...
//     }    @Test
//     public void testFindByLogin() {        List<TelefoneDTO> telefones = new ArrayList<TelefoneDTO>();
//         telefones.add(new TelefoneDTO("83", "999999999"));          
//         EnderecoResponseDTO enderecoDTO = new EnderecoResponseDTO("Rua A", "Bairro X", "123", "Apto 456", "12345-678",
//             Map.of("nome", "Cidade A", "estado", "Estado X"));        
...
//     @Test
//     public void testFindById() {        List<TelefoneDTO> telefones = new ArrayList<TelefoneDTO>();
//         telefones.add(new TelefoneDTO("83", "999999999"));          
//         EnderecoResponseDTO enderecoDTO = new EnderecoResponseDTO("Rua A", "Bairro X", "123", "Apto 456", "12345-678",
//             Map.of("nome", "Cidade A", "estado", "Estado X"));        
